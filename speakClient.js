...
function speak(text, args) {
  ...
  function playHTMLAudioElement(wav) {
    ...
    $('<div id=' + randomnumber + '></div>').appendTo('#audio');
    document.getElementById(randomnumber).innerHTML=("<audio id=\"player" + randomnumber + "\" src=\"data:audio/x-wav;base64,"+encode64(wav)+"\">");
    document.getElementById("player" + randomnumber).play();
  }
